...
public class myedit extends JFrame implements ActionListener
{
 ...
 JMenuItem HELPTOPICSHELP = new JMenuItem("HelpTopics");
 //Jmenuitem Ditelhelp = New Jmenuitem("Ditel");
 ...
 public myedit()
 {
  ...
  //setTitle("Untitlet ");
  //SETING TITLE OF THE FRAME

    setTitle(" TEXT EDITOR                   $$ NITIN $$ ");
  ...
  HELPTOPICSHELP.setMnemonic(KeyEvent.VK_H);
  ...
  HELPTOPICSHELP.addActionListener(this);
